...
public:
  struct Point {
    ...
    Point unit() {
      double l = length();
      return l == 0. ? Point() : Point(x / l, y / l);
    }
    Geometry2D::Point operator-(const Geometry2D::Point &point_1) const {
      return Geometry2D::Point(x - point_1.x, y - point_1.y);
    }
  };
...
public:
  ...
  static double outer(const Geometry2D::Point &point_0,
                      const Geometry2D::Point &point_1) {
    return point_0.x * point_1.y - point_0.y * point_1.x;
  }
  static double ccw(const Geometry2D::Point &point_0,
                    const Geometry2D::Point &point_1,
                    const Geometry2D::Point &point_2) {
    return outer(point_1 - point_0, point_2 - point_0);
  }
  static bool different_side(const Geometry2D::Point &point_0,
                             const Geometry2D::Point &point_1,
                             const Geometry2D::Point &point_2,
                             const Geometry2D::Point &point_3) {
    return ccw(point_0, point_1, point_2) * ccw(point_0, point_1, point_3) < 0;
  }
  static bool segment_intersect(const Geometry2D::Point &point_0,
                                const Geometry2D::Point &point_1,
                                const Geometry2D::Point &point_2,
                                const Geometry2D::Point &point_3) {
    return different_side(point_0, point_1, point_2, point_3) &&
           different_side(point_2, point_3, point_0, point_1);
  }
...
static Geometry2D::Point operator/(const Geometry2D::Point &point,
                                   const double scalar) {
  return Geometry2D::Point(point.x / scalar, point.y / scalar);
}

static Geometry2D::Point operator+=(Geometry2D::Point &point_0,
                                    const Geometry2D::Point &point_1) {
  return point_0 = point_0 + point_1;
}
static Geometry2D::Point operator-=(Geometry2D::Point &point_0,
                                    const Geometry2D::Point &point_1) {
  return point_0 = point_0 - point_1;
